...
export class ListComponent {
  ...
  editData (id:any) {
    this.router.navigate(['mail-template', 'edit', id]);
  }

  getData (id:any) {
    this.router.navigate(['mail-template', 'view', id]);
  }
  ...
  deleteData (id:any) {
    let alertData = {
      ...
      denyButtonText: 'NO',
      confirmCallback: ()=>{
        this.mailTemplateService.delete(id,(response:boolean)=>{
          if(response)
            this.dtRerender();
        });
      },
  ...
  getPaginate(paginate:any, callback:any){
    ...
    this.mailTemplateService.paginate(paginate,(response:any)=>{
  ...
  exportFile(type:string='xlsx'){
    ...
    this.mailTemplateService.exportElsx(postData,(response:boolean)=>{
      if(response)
  ...
  exportPdf(){
    ...
    this.mailTemplateService.exportPdf(postData,(response:boolean)=>{
      if(response)
        console.log("Exported");
    }); 
  }
